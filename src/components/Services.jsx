  ...
  return (
    <div className="w-full bg-[#0B0B18] text-white">
      ...
      <section className="relative w-full h-[60vh] md:h-screen overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 md:left-24 max-w-3xl">
      ...
      {/* ================= DESCRIPTION ================= */}
      <div className="px-10 md:px-24 pt-20 pb-10">
      ...
      {/* ================= SERVICES SCROLL ================= */}
      <div className="px-10 md:px-24 pb-20">
      ...
      {/* ================= CAREER SECTION ================= */}
      <section className="w-full bg-[#F5F4EE] text-[#1A1A1A] py-20 px-10 md:px-24 flex flex-col md:flex-row justify-between gap-10">
